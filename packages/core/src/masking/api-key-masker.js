 ...
 */
export function maskAPIKeys(data) {
    if (typeof data === 'string') {
        return maskKeyInString(data);
    }
    if (Array.isArray(data)) {
        return data.map(item => maskAPIKeys(item));
    }
...
//# sourceMappingURL=api-key-masker.js.map