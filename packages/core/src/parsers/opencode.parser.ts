import type { 
  ...
  OpenCodeMCPServer,
  OpenCodeAgent,
  OpenCodeMCPConfigInput,
  OpenCodeAgentsConfigInput 
...
export class OpenCodeParser {
   ...
   */
  parseMCPConfig(input: OpenCodeMCPConfigInput): { mcpServers: OpenCodeMCPServer[] } {
   ...
   */
  parseAgents(input: OpenCodeAgentsConfigInput): { agents: OpenCodeAgent[] } {
